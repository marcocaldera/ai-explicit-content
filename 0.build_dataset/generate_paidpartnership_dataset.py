...
import os
from generate_target_value import GenerateTargetValue
...
# inizializziamo il generatore di target value
target_value_generator = GenerateTargetValue()
...
for index, js in enumerate(json_files_name):
    with open(os.path.join(path_to_json, js)) as json_file:
        ...
        if len(main_data_position['edge_owner_to_timeline_media']['edges']) != 0:
            ...
            partnership_target_value = target_value_generator.get_target_value(user=username,
                                                                               url_first_image=url_first_image)
            ...
            for i_post, post in enumerate(main_data_position['edge_owner_to_timeline_media']['edges']):
                ...
                json_df.loc[i_post] = [
                    ...
                    partnership_target_value[i_post]
                ]
