...
class ChromeBrowserInfluencerData:
    ...
    def prepare_folder_for_influencer_json():
        influencer_json_folder = './dataset/non-influencer-json-2020/'
    ...
    def outline_user(self, user):
        ...
        with open('dataset/non-influencer-json-2020/' + user + '.json', 'w') as f:
...
username_list = pd.read_csv('./dataset/non_influencer_list.csv')
